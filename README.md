...
![AI Crew Diagram](assets/crewai.png)
...
1. **RAG Agent (Information Indexer)**: Indexes and organizes information on potential companies in a markdown file to make it easily searchable.
...
- **Goal**: Index information into a markdown file for efficient retrieval.
...
- **Goal**: Find potential leads in the U.S. market interested in software development.
...
### 4. Writer Agent
- **Role**: Report Writer
- **Goal**: Compile the findings from the other agents into a comprehensive report.
- **Backstory**: An expert in synthesizing information and generating clear, actionable reports for the sales team.

## Tasks Setup

### 1. Indexing Information
- **Description**: The RAG Agent indexes all relevant company information into a markdown file.
- **Expected Output**: A markdown file with structured, accessible information.

### 2. Opportunity Research
- **Description**: The Opportunity Research Agent identifies U.S. companies that might need Dualboot Partners' services.
...
### 4. Report Writing
- **Description**: The Writer Agent compiles all findings into a detailed report.
- **Expected Output**: A comprehensive report summarizing all the findings and providing actionable recommendations.
...
4. **Lock the dependencies and then install them**:
    ```bash
    poetry lock
    poetry install
    ```
